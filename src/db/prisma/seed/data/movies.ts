...
{
  name: 'El código enigma',
  releaseYear: 2014,
  description:
    'Durante la Segunda Guerra Mundial, el genio inglés Alan Turing intenta descifrar el código alemán enigma con la ayuda de otros matemáticos.',
  director: 'Morten Tyldum',
  protagonists: ['Benedict Cumberbatch', 'Keira Knightley', 'Matthew Goode'],
  comentarioBM: ' Como estudiante de ingenieria en sistemas, esta pelicula logra conmoverme al relatar la historia del padre de la computacion Alan Turing. NOTA-> 9.1',
  lang: 'en',
  posterUrl: '/posters/codigo-enigma.png',
  rating: 9.1,
  genres: ['Basada en hechos reales', 'Drama'],
},
{
  name: 'Memento',
  releaseYear: 2000,
  ...
  protagonists: ['Guy Pearce', 'Carrie-Anne Moss', 'Joe Pantoliano'],
  comentarioBM: 'Un clasico del Thriller psicológico, una pelicula que sorprende. NOTA-> 9.3',
  lang: 'en',
  posterUrl: '/posters/memento.png',
  rating: 9.3,
  genres: ['Suspenso', 'Thriller psicológico'],
},
{
  ...
  releaseYear: 2022,
  description:
    'Una joven se queda varada en un área de descanso de una autopista durante una ventisca y descubre a una chica secuestrada en una furgoneta. Decidida a descubrir la identidad del secuestrador, investiga al grupo de extraños atrapados dentro con ella.',
  director: '	Damien Power',
  protagonists: ['Rosa de La Habana Liu','Danny Ramírez','David Rysdahl','Dale Dickey','Mila Harris','Dennis Haysbert'],
  comentarioBM: 'Una pelicula muy entretenida, que te mantiene en tension constante. NOTA-> 7.6',
  lang: 'en',
  posterUrl: '/posters/sin-salida.png',
  rating: 7.6,
  genres: ['Suspenso', 'Drama'],
},
{
  ...
  protagonists: ['Luis Brandoni', 'China Zorrilla', 'Antonio Gasalla'],
  comentarioBM: 'Un clasico del cine Argentino, con actuaciones memorables y frases icónicas. NOTA-> 7.9',
  lang: 'es',
  posterUrl: '/posters/esperando-la-carroza.png',
  rating: 7.9,
  genres: ['Comedia'],
},
{
  ...
  director: 'Ron Howard',
  protagonists: ['Jim Carrey', 'Taylor Momsen', 'Jeffrey Tambor', 'Christine Baranski'],
  comentarioBM: 'Un clasico de las navidades, para toda la familia. NOTA-> 7.1',
  lang: 'en',
  posterUrl: '/posters/el-grinch.png',
  rating: 6.7,
  genres: ['Familiar', 'Comedia'],
},
{
  ...
  protagonists: ['Macaulay Culkin', 'Joe Pesci', 'Daniel Stern'],
  comentarioBM: ' Un clasico de las navidades, para toda la familia. NOTA-> 7.1',
  lang: 'en',
  posterUrl: '/posters/mi-pobre-angelito.png',
  rating: 7.1,
   genres: ['Familiar', 'Comedia'],
},
{
  name: '¿Qué pasó ayer? 1',
  releaseYear: 2009,
  description:
  ...
  protagonists: ['Bradley Cooper', 'Ed Helms', 'Zach Galifianakis','Justin Bartha','Ken Jeong'],
  comentarioBM: 'Una comedia divertida y alocada, que nadie se la puede perder. NOTA-> 7.9',
  lang: 'en',
  posterUrl: '/posters/que-paso-ayer-1.png',
  rating: 7.9,
   genres: ['Comedia negra', 'Comedia'],
},
{
  name: '¿Qué pasó ayer? 2',
  releaseYear: 2011,
  description:
  ...
  comentarioBM: 'Una comedia divertida y alocada, que nadie se la puede perder. NOTA-> 7.9',
  lang: 'en',
  posterUrl: '/posters/que-paso-ayer-2.png',
  rating: 7.9,
   genres: ['Comedia negra', 'Comedia'],
},
{
  name: '¿Qué pasó ayer? 3',
  releaseYear: 2013,
  description:
    'DPhil, Stu y Doug llevan a Alan a un viaje por carretera para ayudarlo a superar una crisis personal. Mientras tanto, el Sr. Chow sale de prisión y se prepara para desatar un caos.',
  director: 'Todd Phillips',
  protagonists: ['Bradley Cooper', 'Ed Helms', 'Zach Galifianakis','Justin Bartha','Ken Jeong'],
  comentarioBM: 'Una comedia divertida y alocada, que nadie se la puede perder, la fui a ver al cine y no decepciona ninguna de las 3 partes. NOTA-> 7.9',
  lang: 'en',
  posterUrl: '/posters/que-paso-ayer-3.png',
  rating: 7.9,
   genres: ['Comedia negra', 'Comedia'],
},
];
